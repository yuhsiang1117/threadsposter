...
class SizeSelection extends StatefulWidget {
  ...
  const SizeSelection({super.key, this.onSizeSelected, required this.selectedSize});
...
class _SizeSelectionState extends State<SizeSelection> {
  ...
  void initState() {
    super.initState();
    selectedSize = widget.selectedSize.isNotEmpty ? widget.selectedSize : size.first;
